  ...
  return (
    <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
      <section className="relative flex items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        <img
          src="https://images.unsplash.com/photo-1513185041617-8ab03f83d6c5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div className="hidden lg:relative lg:block lg:p-12">
          ...
          <h2 className="mt-6 pb-14 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
            Welcome to BookSelf
          </h2>
        </div>
      </section>
        ...
        <div className="px-20">
          ...
          <form className="mt-8 grid grid-cols-6 gap-6" onSubmit={handleSubmit}>
            ...
            <div className="col-span-6">
              <button
                type="submit"
                className="btn btn-neutral inline-block w-full"
              >
                {" "}
                Log In{" "}
              </button>
